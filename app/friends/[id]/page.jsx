        ...
        <div className="grid md:grid-cols-[300px_1fr] gap-6">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white rounded-2xl p-4 shadow-sm space-y-2">
              <button className="w-full flex justify-center items-center gap-2.5 px-4 py-3 rounded-xl border border-amber-200 text-amber-800 bg-amber-50 hover:bg-amber-100 transition-colors text-sm font-medium">
                <AlarmClock size={15} /> Snooze 2 Weeks
              </button>
              <button className="w-full flex justify-center items-center gap-2.5 px-4 py-3 rounded-xl border border-gray-200 text-gray-600 hover:bg-gray-50 transition-colors text-sm font-medium">
                <Archive size={15} /> Archive
              </button>
              <button className="w-full flex justify-center items-center gap-2.5 px-4 py-3 rounded-xl border border-red-200 text-red-600 bg-red-50 hover:bg-red-100 transition-colors text-sm font-medium">
